...
public class Exercise2 {
   ...
   set counter to 1 to save the length of the Cousin Collatz Sequence
   while n!=1 then two conditions one is for even and one for odd(for odd
